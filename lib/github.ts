...
const REPOS_FALLBACK: GithubRepo[] = [
  ...
  { name: "portfolio", description: "Next.js portfolio application for Karkala Shiva Reddy with typed project data, a Canvas 2D world scene, command palette, and GitHub/Codolio integrations.", html_url: "https://github.com/karkalashivareddy/portfolio", language: "TypeScript", stars: 0, forks: 0, topics: ["nextjs", "portfolio", "react", "tailwindcss", "typescript"], updated_at: "2026-09-16T00:00:00Z", private: false },
  { name: "DataBase-System-and-Distributed-Backend-Development", description: "PharmaStock coursework repository with a React/Vite medicine inventory interface backed by local demo data (Express/Mongoose backend planned, not implemented), and database systems practicals.", html_url: "https://github.com/karkalashivareddy/DataBase-System-and-Distributed-Backend-Development", language: "JavaScript", stars: 0, forks: 0, topics: ["database", "inventory-management", "javascript", "react"], updated_at: "2026-09-16T00:00:00Z", private: false },
